...
public class ExerciseAdapter1 extends RecyclerView.Adapter<ExerciseAdapter1.ViewHolder> {
    private static final String LOG_TAG = ExerciseAdapter1.class.getSimpleName();
    final private ExerciseAdapterOnClickHandler clickHandler;
    private Cursor cursor;
    private Context context;

    public ExerciseAdapter1(Context context, ExerciseAdapterOnClickHandler clickHandler) {
        this.context = context;
        this.clickHandler = clickHandler;
    }

    @Override
    public ExerciseAdapter1.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final ExerciseAdapter1.ViewHolder holder, int position) {
