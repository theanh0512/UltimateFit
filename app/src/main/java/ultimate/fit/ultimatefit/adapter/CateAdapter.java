...
public class CateAdapter extends DataBoundListAdapter<Category, ListItemCategoryBinding> {
    private final CategoryClickCallback categoryClickCallback;

    public CateAdapter(CategoryClickCallback categoryClickCallback) {
    ...
    protected boolean areItemsTheSame(Category oldItem, Category newItem) {
        return Objects.equals(oldItem.categoryName, newItem.categoryName) &&
